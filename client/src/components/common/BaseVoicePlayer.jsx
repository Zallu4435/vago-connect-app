...
export default function BaseVoicePlayer({
  ...
  return (
    <div
      className={`relative flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-xl shadow-lg border transition-all duration-200 min-w-[220px] sm:min-w-[280px] max-w-full ${bubbleClass}`}
    >
      ...
      <div className="flex-1 flex flex-col justify-center min-w-0">
        ...
        <div className={`flex justify-between text-[10px] sm:text-[11px] pt-1 ${isIncoming ? "text-ancient-text-muted" : "text-ancient-text-muted"}`}>
        ...
        {hasError && (
          <div className="text-red-400 text-[10px] sm:text-xs mt-1 italic">
