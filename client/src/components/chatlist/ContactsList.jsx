    ...
    <AnimatedPanel open={open} direction="left">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar min-h-0">
        {isLoading && !data?.pages?.length ? (
          ...
          <div key="error" className="flex flex-col items-center justify-center p-6 gap-4 mt-4">
          ...
          <div key="no-results" className="w-full py-8">
            <EmptyState title="No contacts found." layout="embedded" />
          </div>
        ) : (
